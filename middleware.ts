...
export function middleware(req: NextRequest) {
  ...
  const isAdminOrInternal = pathname === "/admin" || pathname === "/compare" || pathname === "/charts" || pathname === "/upload" || pathname === "/data-completion" || pathname === "/analysis" || pathname === "/fund-status";
