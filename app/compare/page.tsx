...
// ── Palette ──────────────────────────────────────────────────────────────────
const FUND_COLORS = ["#B8975A", "#2563eb", "#9333ea", "#16a34a"];
...
function ComparePrint({ funds, brand, lastUpdated, mode, selectedYears, chartFrom, chartTo, benchmarks }: {
  ...
  return (
    <div className="print-only" style={{ width: "100%", background: "white", color: "#1a1f2b", fontFamily: "Assistant, Arial, sans-serif", display: "flex", flexDirection: "column", height: "267mm", padding: "0 10mm", boxSizing: "border-box" }}>
      ...
      {/* ── Chart ── */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", paddingTop: "28mm", paddingBottom: "0" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
          <div style={{ textAlign: "center", fontSize: "8pt", color: "#8893a4", fontFamily: "Assistant, sans-serif", marginBottom: "4px" }}>
            {chartFrom} – {chartTo}
          </div>
