...
7. כשמציינים נתונים ממספר חלונות זמן (12M, 24M, 36M) — דווח כל ערך כעובדה עצמאית בלבד. אסור: "השתפרה", "ירדה", "מגמת שיפור", "מגמת ירידה", "יציב", "בשיפור", "בהחמרה", "מצביע על שיפור", "מצביע על ירידה". דוגמה אסורה: "ה-IR השתפר מ-0.3 ל-0.7". דוגמה מותרת: "ה-IR עמד על 0.3 בחלון 24 חודשים ועל 0.7 בחלון 36 חודשים".
...
export const FUND_FORBIDDEN_WORDS = [
  ...
  "השתפרה", "מגמת", "בשיפור", "בהחמרה", "מצביע על",
];
